...
import evote from '../../../../public/evote-about.png';
import './page.css';

export default function About() {
    return (
        <section className="bg-gray-50 min-h-auto flex-1 flex items-center justify-center px-16 pt-28 lg:pt-20" aria-label="Sekcja instrukcji głosowania">
                ...
                <div className="m-8 relative space-y-8">
                    ...
                    <div className="flex flex-col md:flex-row bg-transparent rounded-xl gap-10">
                        ...
                        <div
                            ...
                            <p>
                                Aby rozpocząć, załóż konto na naszej platformie. Kliknij przycisk &quot;Zaloguj się&quot;, a następnie &quot;Rejestracja&quot; i podaj swój adres e-mail oraz hasło.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row bg-transparent rounded-xl gap-10">
                        ...
                        <div
                            ...
                            <p>
                                Po zalogowaniu się, wejdź w zakładkę &quot;Moje konto&quot; i wypełnij dodatkowe informacje potrzebne do weryfikacji tożsamości.
                                Wprowadź swoje dane osobowe, takie jak PESEL czy adres zamieszkania. Wszystkie dane są zabezpieczone i przetwarzane zgodnie z przepisami o ochronie danych osobowych.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row bg-transparent rounded-xl gap-10">
                        ...
                        <div
                            ...
                            <p>
                                Następnie rzejdź do sekcji &quot;Kandydaci&quot;. Tam znajdziesz listę dostępnych wyborów oraz kandydatów.
                                Możesz przeglądać profile kandydatów, czytać ich programy wyborcze i zapoznać się z ich priorytetami.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row bg-transparent rounded-xl gap-10">
                        ...
                        <div
                            ...
                            <p>
                                Gdy już zdecydujesz, na kogo chcesz oddać głos, w sekcji &quot;Moje konto&quot; wygeneruj kod umożliwiający zagłosowanie.
                                Po otrzymaniu go na podany adres e-mail, przejdź do sekcji &quot;Zagłosuj&quot; i wpisz kod.
                                Twój głos na wybranego kandydata zostanie zarejestrowany i możesz być pewny, że jest bezpieczny i anonimowy.
                            </p>
                        </div>
                    </div>
