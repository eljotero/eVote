...
import about from '../../../../public/images/evote-about.png';
import about2 from '../../../../public/images/evote-about2.png';
import './page.css';
...
export default function About() {
    return (
        <section className="bg-gray-50 min-h-auto flex-1 flex items-center justify-center px-16 pt-28 lg:pt-20"
            ...
            <div className="lg:absolute lg:top-20 lg:left-40 lg:mb-8 lg:mr-8 hidden sm:hidden md:hidden lg:block">
                <Image src={about2} alt="Waga" width={600} height={600}/>
            </div>
                ...
                <div className="m-8 relative space-y-8 z-10">
                    ...
                    <div className="flex flex-col md:flex-row bg-transparent rounded-xl gap-10">
                        ...
                        <div
                            ...
                            <p>
                                ...
                                Wprowadź swoje dane osobowe, takie jak PESEL czy adres zamieszkania. Wszystkie dane są
                    ...
                    <div className="flex flex-col md:flex-row bg-transparent rounded-xl gap-10">
                        ...
                        <div
                            ...
                            <p>
                                Następnie rzejdź do sekcji &quot;Kandydaci&quot;. Tam znajdziesz listę dostępnych
                                wyborów oraz kandydatów.
                                Możesz przeglądać profile kandydatów, czytać ich programy wyborcze i zapoznać się z ich
                                priorytetami.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row bg-transparent rounded-xl gap-10">
                        ...
                        <div
                            ...
                            <p>
                                ...
                                Po otrzymaniu go na podany adres e-mail, przejdź do sekcji &quot;Zagłosuj&quot; i wpisz
                                kod.
            ...
            <div className="lg:absolute lg:bottom-0 lg:right-0 lg:mr-8 hidden sm:hidden md:hidden lg:block">
                <Image src={about} alt="Ludzie zachęcający do głosowania" width={950} height={900}/>
            </div>
