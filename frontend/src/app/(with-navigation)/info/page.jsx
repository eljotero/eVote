...
import info from '../../../../public/images/evote-info.png';
                    ...
                    <div className="mt-12 md:mt-0 lg:absolute left-0 lg:w-7/12">
                        <div className="relative w-full">
                            <div aria-hidden="true"
                                 className="absolute scale-65 md:scale-90 inset-0 right-80 bottom-80 m-auto w-full h-full md:w-96 md:h-96 rounded-full rotate-45"></div>
                            <Image src={info} alt="Ilustracja kobiety zaznaczającej swój wybór na karcie głosowań" className="relative w-full" loading='lazy'
                                   layout='responsive'/>
                        </div>
                    </div>
                </div>
