...
const personInfoSchema = z.object({
    ...
    profession: z.string(),
    cityType: z.string(),
    personalIdNumber: z.string().min(11, 'Numer PESEL musi mieć 11 cyfr'),
    zipCode: z.string(),
    city: z.string(),
    country: z.string(),
...
export default function Account() {
    ...
    return (
        <div
            className='flex justify-center items-center relative top-35'>
            <form onSubmit={handleSubmit(onSubmit)}
                  className='bg-slate-50 rounded-md border border-solid border-gray-500 grid grid-rows-3 grid-cols-1 justify-items-center items-center justify-evenly'>
                <div
                    className='grid grid-rows-4 grid-cols-2 w-5/6 mt-4 gap-2'>
                    <LabeledInput
                        label='Email'
                        register={register}
                        name='email'
                ...
                <div
                    className='grid grid-rows-3 grid-cols-2 w-5/6 gap-2'>
                    <LabeledInput
                        label='Kod pocztowy'
                        register={register}
                        name='zipCode'
                ...
                <div
                    className='grid grid-cols-1 grid-rows-2 gap-5 justify-items-center items-center'>
                    <button
                        onClick={sendEmail}
                        className='bg-blue-500 rounded-md w-3/4 text-white'
                    >
                        Wygeneruj swój kod do głosowania
                    </button>
                    <button
                        disabled={isSubmitting}
                        className='bg-green-500 rounded-md w-3/4 h-3/4 text-white'
                        type={"submit"}
                    >
                        Zapisz
                    </button>
