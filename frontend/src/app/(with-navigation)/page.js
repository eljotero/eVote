        ...
        <div className="bg-white relative pt-40 pb-20 lg:pt-44">
            <div className="relative xl:container m-auto px-6 md:px-12 lg:px-6">
                ...
                <div className="lg:flex">
                    <div
                        className="relative mt-8 md:mt-16 space-y-8 sm:w-10/12 md:w-2/3 lg:ml-0 sm:mx-auto text-center lg:text-left lg:mr-auto lg:w-7/12">
                        <p className="sm:text-lg text-gray-700 lg:w-11/12">
                            Witaj na eVote, platformie do elektronicznego głosowania, dzięki któremu możesz w wygodny dla siebie sposób uczestniczyć w demokracji.
                            Nasza aplikacja zapewnia bezpieczny, szybki i wygodny sposób oddania głosu bez konieczności wychodzenia z domu.
                        </p>
                        <span className="block font-semibold text-gray-500">
                            <a href='/login' className='hover:underline'>Zarejestruj się teraz</a> i bądź częścią zmiany!
                        </span>
                            ...
                            <a aria-label="add to slack" href="#"
                               className="p-4 border border-gray-200 rounded-full duration-300 hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-600/20 flex items-center justify-center">
                                <div className="flex justify-center items-center space-x-4">
                                    <FaQuestion size={32}/>
                                    <span className="font-medium md:block text-center">Dowiedz się, jak to działa</span>
                                </div>
                            </a>
                            <a aria-label="add to chat" href="#"
                               className="p-4 border border-gray-200 rounded-full duration-300 hover:border-green-400 hover:shadow-lg hover:shadow-lime-600/20 flex items-center justify-center">
                                <div className="flex justify-center items-center space-x-4">
